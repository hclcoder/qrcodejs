/**
 * @author hclcoder 
 * @description this javascript library is based on davidshimjs's qrcodjs. 
 */

(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
    typeof define === 'function' && define.amd ? define(factory) :
      (global = global || self, global.HQrCode = factory());
}(this, function () {
  'use strict'
  ...
  QRCode = function (el, vOption) {
    ...
    typeof vOption === 'string' ? vOption = { text: vOption } : '';
  ...
  QRCode.prototype.version = '1.0.0';
  ...
  QRCode.prototype.drawQrCode = function () {
